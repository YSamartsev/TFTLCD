...
#line 24 "..\\Src\\stm32f1xx_hal_msp.c"
...
void HAL_MspInit(void)
{
  ...
  do{ uint32_t tmpreg = ((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->MAPR; tmpreg &= ~(0x7UL << (24U)); tmpreg |= (0x1UL << (24U)); ((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->MAPR = tmpreg; }while(0u);
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) |= ((0x1UL << (14U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) & ((0x1UL << (14U)))); (void)tmpreg; } while(0U);;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef *huart)
{
  ...
  (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2RSTR |= ((0x1UL << (14U))));
  (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2RSTR &= ~((0x1UL << (14U))));

   
   
  HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0200));
   
  HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0400));
...
#line 202 "..\\Src\\stm32f1xx_hal_msp.c"
  
    
    
  (*(volatile uint32_t *) ((uint32_t)(0x42000000UL + (((((0x40000000UL + 0x00020000UL) + 0x00001000UL) - 0x40000000UL) + 0x20U) * 32U) + ((15U) * 4U))) = ENABLE); 
...
void HAL_RTC_MspDeInit(RTC_HandleTypeDef* hrtc)
{
  if(hrtc->Instance==((RTC_TypeDef *)(0x40000000UL + 0x00002800UL)))
  {
   

   
     
    (*(volatile uint32_t *) ((uint32_t)(0x42000000UL + (((((0x40000000UL + 0x00020000UL) + 0x00001000UL) - 0x40000000UL) + 0x20U) * 32U) + ((15U) * 4U))) = DISABLE);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi)
{
  ...
  if(hspi->Instance==((SPI_TypeDef *)(0x40000000UL + 0x00003800UL)))
  {
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==((SPI_TypeDef *)(0x40000000UL + 0x00003800UL)))
  {
    ...
    (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR &= ~((0x1UL << (14U))));
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000));
