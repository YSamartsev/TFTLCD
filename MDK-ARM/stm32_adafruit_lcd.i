#line 1 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
...
#line 73 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 74 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 1 "../Inc/../../Utilities/Fonts/font24.c"
...
#line 40 "../Inc/../../Utilities/Fonts/font24.c"
...
#line 75 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 1 "../Inc/../../Utilities/Fonts/font20.c"
...
#line 40 "../Inc/../../Utilities/Fonts/font20.c"
...
#line 76 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 1 "../Inc/../../Utilities/Fonts/font16.c"
...
#line 40 "../Inc/../../Utilities/Fonts/font16.c"
...
#line 77 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 1 "../Inc/../../Utilities/Fonts/font12.c"
...
#line 40 "../Inc/../../Utilities/Fonts/font12.c"
...
#line 78 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 1 "../Inc/../../Utilities/Fonts/font8.c"
...
#line 40 "../Inc/../../Utilities/Fonts/font8.c"
...
#line 79 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 80 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
#line 81 "..\\Drivers\\BSP\\Adafruit_Shield\\stm32_adafruit_lcd.c"
...
static uint8_t bitmap[17*24*2+54] = {0};
  ...
  for(counter = 0; counter < 240; counter++) 
	{
		...
		ST7789_DrawLine(0, counter, 239, counter, 0xFFFF);
  }
...
void BSP_LCD_DisplayStringAtLine(uint16_t Line, uint8_t *ptr)
{
  BSP_LCD_DisplayStringAt(0, ((Line) * (((sFONT *)BSP_LCD_GetFont())->Height)), ptr, LEFT_MODE);
}
...
void BSP_LCD_FillPolygon(pPoint Points, uint16_t PointCount)
{
  ...
  {
    pixelX = ((int32_t)((Points + (counter))->X));
    ...
    pixelY = ((int32_t)((Points + (counter))->Y));
    if(pixelY < IMAGE_TOP)
    {
      IMAGE_TOP = pixelY;
    }
...
static void DrawChar(uint16_t Xpos, uint16_t Ypos, const uint8_t *pChar)
{
  ...
  *(uint16_t *) (bitmap + 2) = (uint16_t)(height*width*2+54);
  *(uint16_t *) (bitmap + 4) = (uint16_t)((height*width*2+54)>>16);
  *(uint16_t *) (bitmap + 10) = 54;
  ...
  *(uint16_t *) (bitmap + 24) = (uint16_t)((height)>>16);
  ...
  for(counterh = 0; counterh < height; counterh++)
  {
    ...
    for (counterw = 0; counterw < width; counterw++)
    {
      ...
      index = (((height-counterh-1)*width)+(counterw))*2+54;
