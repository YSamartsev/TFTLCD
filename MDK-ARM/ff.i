...
#line 127 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 128 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 152 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"




 
#line 165 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"


 
#line 176 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 335 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"

#line 388 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 410 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 425 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 473 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"

#line 495 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
static FILESEM Files[12];	 


#line 546 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 652 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
)
{
	...
	if (res == FR_OK) {
		...
		if (fs->fs_type == 3 && fs->fsi_flag == 1) {
			...
			mem_set(fs->win.d8, 0, ((UINT)512));
			*(BYTE*)(fs->win . d8 + 510)=(BYTE)(0xAA55); *((BYTE*)(fs->win . d8 + 510)+1)=(BYTE)((WORD)(0xAA55)>>8);
			*(BYTE*)(fs->win . d8 + 0)=(BYTE)(0x41615252); *((BYTE*)(fs->win . d8 + 0)+1)=(BYTE)((WORD)(0x41615252)>>8); *((BYTE*)(fs->win . d8 + 0)+2)=(BYTE)((DWORD)(0x41615252)>>16); *((BYTE*)(fs->win . d8 + 0)+3)=(BYTE)((DWORD)(0x41615252)>>24);
			*(BYTE*)(fs->win . d8 + 484)=(BYTE)(0x61417272); *((BYTE*)(fs->win . d8 + 484)+1)=(BYTE)((WORD)(0x61417272)>>8); *((BYTE*)(fs->win . d8 + 484)+2)=(BYTE)((DWORD)(0x61417272)>>16); *((BYTE*)(fs->win . d8 + 484)+3)=(BYTE)((DWORD)(0x61417272)>>24);
			*(BYTE*)(fs->win . d8 + 488)=(BYTE)(fs->free_clust); *((BYTE*)(fs->win . d8 + 488)+1)=(BYTE)((WORD)(fs->free_clust)>>8); *((BYTE*)(fs->win . d8 + 488)+2)=(BYTE)((DWORD)(fs->free_clust)>>16); *((BYTE*)(fs->win . d8 + 488)+3)=(BYTE)((DWORD)(fs->free_clust)>>24);
			*(BYTE*)(fs->win . d8 + 492)=(BYTE)(fs->last_clust); *((BYTE*)(fs->win . d8 + 492)+1)=(BYTE)((WORD)(fs->last_clust)>>8); *((BYTE*)(fs->win . d8 + 492)+2)=(BYTE)((DWORD)(fs->last_clust)>>16); *((BYTE*)(fs->win . d8 + 492)+3)=(BYTE)((DWORD)(fs->last_clust)>>24);
...
#line 1047 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
			clst = nxt;	 
		}
	}
...
)
{
	...
	dp->dir = dp->fs->win.d8 + (idx % (((UINT)512) / 32)) * 32;	 
...
)
{
		...
		if (!dp->clust) {		 
			...
			if (((i / (((UINT)512) / 32)) & (dp->fs->csize - 1)) == 0) {	 
				...
				if (clst >= dp->fs->n_fatent) {					 
					...
					mem_set(dp->fs->win.d8, 0, ((UINT)512));		 
	...
	dp->index = (WORD)i;	 
	dp->dir = dp->fs->win.d8 + (i % (((UINT)512) / 32)) * 32;	 
...
#line 1440 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 1499 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 1519 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 1572 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
)
{
	...
	while (dp->sect) {
		...
		if (c == 0) { res = FR_NO_FILE; break; }	 
		a = dir[11] & 0x3F;
#line 1627 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
{
	FRESULT res;
#line 1699 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
	res = dir_alloc(dp, 1);		 
...
{
	FRESULT res;
#line 1750 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
)
{
	...
	if (dp->sect) {		 
		...
		while (i < 11) {		 
			...
			if (i == 9) *p++ = '.';				 
#line 1804 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
			*p++ = c;
		}
		fno->fattrib = dir[11];				 
...
#line 1832 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
}
...
#line 1904 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
{
#line 2042 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
	BYTE b, c, d, *sfn;
	UINT ni, si, i;
	const char *p;
	...
	mem_set(sfn, ' ', 11);
	si = i = b = 0; ni = 8;
#line 2064 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
	for (;;) {
		c = (BYTE)p[si++];
		if (c <= ' ' || c == '/' || c == '\\') break;	 
		if (c == '.' || i >= ni) {
...
#line 2141 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
	if (*path == '/' || *path == '\\')		 
		path++;
	dp->sclust = 0;							 
...
)
{
	...
	UINT i;
	int vol = -1;
#line 2200 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 2229 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
			return vol;
		}
...
)
{
	...
	if ((WORD)(((WORD)*((BYTE*)(&fs->win . d8[510])+1)<<8)|(WORD)*(BYTE*)(&fs->win . d8[510])) != 0xAA55)	 
		return 2;

	if (((DWORD)(((DWORD)*((BYTE*)(&fs->win . d8[54])+3)<<24)|((DWORD)*((BYTE*)(&fs->win . d8[54])+2)<<16)|((WORD)*((BYTE*)(&fs->win . d8[54])+1)<<8)| *(BYTE*)(&fs->win . d8[54])) & 0xFFFFFF) == 0x544146)		 
		return 0;
	if (((DWORD)(((DWORD)*((BYTE*)(&fs->win . d8[82])+3)<<24)|((DWORD)*((BYTE*)(&fs->win . d8[82])+2)<<16)|((WORD)*((BYTE*)(&fs->win . d8[82])+1)<<8)| *(BYTE*)(&fs->win . d8[82])) & 0xFFFFFF) == 0x544146)	 
		return 0;
...
)
{
	...
	*rfs = fs;							 
	...
	if ((WORD)(((WORD)*((BYTE*)(fs->win . d8 + 11)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 11)) != ((UINT)512))	 
		return FR_NO_FILESYSTEM;

	fasize = (WORD)(((WORD)*((BYTE*)(fs->win . d8 + 22)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 22));			 
	if (!fasize) fasize = (DWORD)(((DWORD)*((BYTE*)(fs->win . d8 + 36)+3)<<24)|((DWORD)*((BYTE*)(fs->win . d8 + 36)+2)<<16)|((WORD)*((BYTE*)(fs->win . d8 + 36)+1)<<8)| *(BYTE*)(fs->win . d8 + 36));
	fs->fsize = fasize;

	fs->n_fats = fs->win.d8[16];					 
	if (fs->n_fats != 1 && fs->n_fats != 2)				 
		return FR_NO_FILESYSTEM;
	fasize *= fs->n_fats;								 

	fs->csize = fs->win.d8[13];				 
	if (!fs->csize || (fs->csize & (fs->csize - 1)))	 
		return FR_NO_FILESYSTEM;

	fs->n_rootdir = (WORD)(((WORD)*((BYTE*)(fs->win . d8 + 17)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 17));	 
	if (fs->n_rootdir % (((UINT)512) / 32))				 
		return FR_NO_FILESYSTEM;

	tsect = (WORD)(((WORD)*((BYTE*)(fs->win . d8 + 19)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 19));			 
	if (!tsect) tsect = (DWORD)(((DWORD)*((BYTE*)(fs->win . d8 + 32)+3)<<24)|((DWORD)*((BYTE*)(fs->win . d8 + 32)+2)<<16)|((WORD)*((BYTE*)(fs->win . d8 + 32)+1)<<8)| *(BYTE*)(fs->win . d8 + 32));

	nrsv = (WORD)(((WORD)*((BYTE*)(fs->win . d8 + 14)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 14));			 
	...
	if (fmt == 3) {
		...
		fs->dirbase = (DWORD)(((DWORD)*((BYTE*)(fs->win . d8 + 44)+3)<<24)|((DWORD)*((BYTE*)(fs->win . d8 + 44)+2)<<16)|((WORD)*((BYTE*)(fs->win . d8 + 44)+1)<<8)| *(BYTE*)(fs->win . d8 + 44));	 
	...
	if (fmt == 3				 
		&& (WORD)(((WORD)*((BYTE*)(fs->win . d8 + 48)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 48)) == 1
		&& move_window(fs, bsect + 1) == FR_OK)
	{
		fs->fsi_flag = 0;
		if ((WORD)(((WORD)*((BYTE*)(fs->win . d8 + 510)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 510)) == 0xAA55	 
			&& (DWORD)(((DWORD)*((BYTE*)(fs->win . d8 + 0)+3)<<24)|((DWORD)*((BYTE*)(fs->win . d8 + 0)+2)<<16)|((WORD)*((BYTE*)(fs->win . d8 + 0)+1)<<8)| *(BYTE*)(fs->win . d8 + 0)) == 0x41615252
			&& (DWORD)(((DWORD)*((BYTE*)(fs->win . d8 + 484)+3)<<24)|((DWORD)*((BYTE*)(fs->win . d8 + 484)+2)<<16)|((WORD)*((BYTE*)(fs->win . d8 + 484)+1)<<8)| *(BYTE*)(fs->win . d8 + 484)) == 0x61417272)
		{

			fs->free_clust = (DWORD)(((DWORD)*((BYTE*)(fs->win . d8 + 488)+3)<<24)|((DWORD)*((BYTE*)(fs->win . d8 + 488)+2)<<16)|((WORD)*((BYTE*)(fs->win . d8 + 488)+1)<<8)| *(BYTE*)(fs->win . d8 + 488));


			fs->last_clust = (DWORD)(((DWORD)*((BYTE*)(fs->win . d8 + 492)+3)<<24)|((DWORD)*((BYTE*)(fs->win . d8 + 492)+2)<<16)|((WORD)*((BYTE*)(fs->win . d8 + 492)+1)<<8)| *(BYTE*)(fs->win . d8 + 492));
	...
	if (res == FR_OK) {
		...
		if (mode & (0x08 | 0x10 | 0x04)) {
			...
			if (res == FR_OK && (mode & 0x08)) {	 
				dw = ((DWORD)(2015 - 1980) << 25 | (DWORD)5 << 21 | (DWORD)1 << 16);				 
...
#line 2631 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
		;
...
)
{
	...
	*br = 0;	 
	...
	for ( ;  btr;								 
		...
		if ((fp->fptr % ((UINT)512)) == 0) {		 
			...
			if (cc) {							 
				...
				if ((fp->flag & 0x40) && fp->dsect - sect < cc)
					mem_cpy(rbuff + ((fp->dsect - sect) * ((UINT)512)), fp->buf.d8, ((UINT)512));
			...
			if (fp->dsect != sect) {			 
				...
				if (disk_read(fp->fs->drv, fp->buf.d8, sect, 1) != RES_OK)	 
					{ fp->err = (BYTE)(FR_DISK_ERR); return FR_DISK_ERR; };
			}
		...
		mem_cpy(rbuff, &fp->buf.d8[fp->fptr % ((UINT)512)], rcnt);	 
		...
		if ((fp->fptr % ((UINT)512)) == 0) {	 
			...
			if (cc) {						 
				...
				if (disk_write(fp->fs->drv, wbuff, sect, cc) != RES_OK)
					{ fp->err = (BYTE)(FR_DISK_ERR); return FR_DISK_ERR; };
#line 2832 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
				if (fp->dsect - sect < cc) {  
					mem_cpy(fp->buf.d8, wbuff + ((fp->dsect - sect) * ((UINT)512)), ((UINT)512));
					fp->flag &= ~0x40;
				}
...
#line 2847 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
			if (fp->dsect != sect) {		 
				if (fp->fptr < fp->fsize &&
...
#line 2863 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
		mem_cpy(&fp->buf.d8[fp->fptr % ((UINT)512)], wbuff, wcnt);	 
		fp->flag |= 0x40;
		...
		if (fp->flag & 0x20) {	 
			...
			if (res == FR_OK) {
				...
				*(BYTE*)(dir + 28)=(BYTE)(fp->fsize); *((BYTE*)(dir + 28)+1)=(BYTE)((WORD)(fp->fsize)>>8); *((BYTE*)(dir + 28)+2)=(BYTE)((DWORD)(fp->fsize)>>16); *((BYTE*)(dir + 28)+3)=(BYTE)((DWORD)(fp->fsize)>>24);	 
				...
				tm = ((DWORD)(2015 - 1980) << 25 | (DWORD)5 << 21 | (DWORD)1 << 16);							 
...
#line 3094 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
			...
			*fp->cltbl = ulen;	 
			...
			if (ofs) {
				...
				if (fp->fptr % ((UINT)512) && dsc != fp->dsect) {	 
					...
					if (disk_read(fp->fs->drv, fp->buf.d8, dsc, 1) != RES_OK)	 
						{ fp->err = (BYTE)(FR_DISK_ERR); return FR_DISK_ERR; };
...
#line 3434 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
)
{
	...
	DIR dj;
	BYTE *dir, n;
	DWORD dsc, dcl, pcl, tm = ((DWORD)(2015 - 1980) << 25 | (DWORD)5 << 21 | (DWORD)1 << 16);
	BYTE sfn[12];
...
#line 4067 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 4127 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
)
{
	...
	if (0 && part) {
		...
		if ((WORD)(((WORD)*((BYTE*)(fs->win . d8 + 510)+1)<<8)|(WORD)*(BYTE*)(fs->win . d8 + 510)) != 0xAA55) return FR_MKFS_ABORTED;
		tbl = &fs->win.d8[446 + (part - 1) * 16];
	...
	if (0 && part) {
		...
		tbl = &fs->win.d8[446 + (part - 1) * 16];
		tbl[4] = sys;
		if (disk_write(pdrv, fs->win.d8, 0, 1) != RES_OK)	 
			return FR_DISK_ERR;
		md = 0xF8;
	} else {
		if (sfd) {	 
	...
	*(BYTE*)(tbl + 28)=(BYTE)(b_vol); *((BYTE*)(tbl + 28)+1)=(BYTE)((WORD)(b_vol)>>8); *((BYTE*)(tbl + 28)+2)=(BYTE)((DWORD)(b_vol)>>16); *((BYTE*)(tbl + 28)+3)=(BYTE)((DWORD)(b_vol)>>24);		 
	n = ((DWORD)(2015 - 1980) << 25 | (DWORD)5 << 21 | (DWORD)1 << 16);						 
	if (fmt == 3) {
...
#line 4362 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 4448 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
)
{
	...
	while (n < len - 1) {	 
#line 4514 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
		f_read(fp, s, 1, &rc);
		if (rc != 1) break;
		c = s[0];
...
#line 4532 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
...
#line 4586 "..\\Middlewares\\Third_Party\\FatFs\\src\\ff.c"
	pb->buf[i++] = (BYTE)c;
